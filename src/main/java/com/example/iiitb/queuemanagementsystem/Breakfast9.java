...
public class Breakfast9 extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if((Contact)(getIntent().getSerializableExtra("Contact"))!=null) {
                    ...
                    if(getIntent().getIntExtra("I",0)==1){
                        ...
                        int i =0;
                        c.setBfFlag(1);
                        Intent i1 = new Intent(Breakfast9.this, Student.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((Contact)(getIntent().getSerializableExtra("Contact"))!=null) {
                    Contact c = (Contact)(getIntent().getSerializableExtra("Contact"));
                    Intent i1 = new Intent(Breakfast9.this, Breakfast.class);
