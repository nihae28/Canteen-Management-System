...
public class LunchCanteen extends AppCompatActivity{

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lunchcanteen);

        Button b = (Button)findViewById(R.id.LunchCanteenBack);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((Contact)(getIntent().getSerializableExtra("Contact"))!=null) {
                    ...
                    Intent i1 = new Intent(LunchCanteen.this, Student.class);
